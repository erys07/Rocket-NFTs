    ...
    return<div id="header" className="flex flex-row justify-between p-10">
        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <a href="" className="flex md:items-center px-2 lg:px-4 text-sm lg:text-base py-2 bg-white font-semibold sm:font-bold md:ml-10"><img src={Mask} className="w-6 mr-1"/>Conectar carteira</a>
            </div>
            </nav>
        </div>
    </div>
